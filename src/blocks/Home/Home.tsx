    ...
    <div className="w-full pb-0 md:py-0 px-0 md:px-6 pt-[5vh] md:pt-[13vh]">
      <div className="w-full  ">
        ...
        <p className="text-[15px] font-normal text-primary-50 leading-6 mb-6 md:mb-0">
          Hello, I am Omotayo but people call me "Omotee". I am passionate abou
          solving problems faced by the society using the best technologies. I
          love paying attention to details. One of the things that makes me
